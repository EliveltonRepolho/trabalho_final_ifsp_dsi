...
public class JanelaManterIngrediente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jScrollBar1.setName("tableScrool"); // NOI18N
    ...
    private void preparaEditar() {
        ...
        txtQtdeMinima.setEnabled(true);
        txtValorCusto.setEnabled(true);
        flagBabida.setEnabled(true);
        flagPrato.setEnabled(true);
    ...
    private boolean validaForm() {
        ...
        }else if(Long.valueOf(txtQtdeEstoque.getText()) < 0){
        ...
        }else if(Long.valueOf(txtQtdeMinima.getText()) < 0){
            String aux = "Quantidade mínima de estoque deve ser um valor positivo ou zero !";
            texto += texto.equals("") ? aux : "\n" + aux;
            valid = false;
        }
        
        if(txtValorCusto.getText().equals("") || Long.valueOf(txtValorCusto.getText()) == 0){

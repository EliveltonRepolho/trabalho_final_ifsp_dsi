 ...
 * @author repolho
 */
public class JanelaManterDrink extends javax.swing.JFrame {
    ...
    private ModeloTabelaMontavel modelDrinks;
    
    /**
     * Creates new form JanelaCadItemProduto
     */
    public JanelaManterDrink() {
        initComponents();
    ...
    private void initComponents() {
        ...
        tableDrinks.setModel(modelDrinks);
        tableDrinks.setColumnSelectionAllowed(true);
        tableDrinks.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tableDrinksMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tableDrinks);
        tableDrinks.getColumnModel().getSelectionModel().setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        ...
        jLabel9.setText("Ingrediente que compõe o drink");
    ...
    private void actionExcluir(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_actionExcluir
        if(MessageBox.showAskYesNo("Excluir ?") == MessageBox.YES_OPTION){
            ...
            modelDrinks.removeRow(montavel);
        }        
    ...
    private void btnExcluirSelecionados(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirSelecionados
        List<Montavel> selecionados = modelDrinks.getSelecionados();
        
        if(MessageBox.showAskYesNo("Excluir ?") == MessageBox.YES_OPTION){
            for (Montavel m : selecionados) {

                if(mMontavelBO.apagar(m))
                    modelDrinks.removeRow(m);
            }
        }
    ...
    private void tableDrinksMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableDrinksMouseClicked
        Montavel montavel = modelDrinks.getValueAt(tableDrinks.getSelectedRow());
        mMontavelIngredientes = mMontavelBO.listarByMontavel(montavel);
        atualizaValores();
        preparaEditavel(false);
    }//GEN-LAST:event_tableDrinksMouseClicked
    ...
    private void populaComboIngredientes(){
        ...
        List<Ingrediente> ingredientes = bo.listarByTipo(MontavelTipo.DRINK);

...
public class ModeloTabelaReserva extends AbstractTableModel{
    ...
    private String[] columns = {"Cliente", "Telefone", "Mesa" ,"Data", "#"};
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        switch (columnIndex) {
            ...
            case 2:
                return reservas.get(rowIndex).getMesa().getNumero();
            case 3:
                DateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy  HH:mm");                
                return dateFormat.format(reservas.get(rowIndex).getDataHora().getTime());
            default:
                break;
        }
